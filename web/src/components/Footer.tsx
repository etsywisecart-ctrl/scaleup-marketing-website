...
const SOCIAL_META: Record<string, { label: string; handle: string; color: string; glyph: React.ReactNode }> = {
  ...
  tiktok: {
    label: "TikTok",
    handle: "scaleup_marketing",
    color: "#010101",
    glyph: (
      <path d="M16.6 5.82A4.28 4.28 0 0 1 15.52 3h-3.1v12.4a2.6 2.6 0 1 1-2.59-2.6c.27 0 .53.04.78.12V9.77a5.8 5.8 0 0 0-.78-.05 5.68 5.68 0 1 0 5.69 5.68V9.29a7.35 7.35 0 0 0 4.3 1.38V7.58a4.33 4.33 0 0 1-3.22-1.76Z" />
    ),
  },
};
